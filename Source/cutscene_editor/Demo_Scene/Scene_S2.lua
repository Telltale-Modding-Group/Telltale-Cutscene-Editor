...
local kScene = "adv_lakeBridge"; --(the name of the scene asset file)
local agent_name_scene = "adv_lakeBridge.scene"; --(the name of the scene agent object)
...
DemoScene = function()
    ...
    CutsceneEditor("cutscene_s2","sk56_clementine200.prop");
