...
local kScene = "adv_bellTower"; --(the name of the scene asset file)
local agent_name_scene = "adv_bellTower.scene"; --(the name of the scene agent object)
...
DemoScene = function()
    ...
    ResourceSetEnable("WalkingDead405"); 
    ...
    CutsceneEditor("cutscene_s4","sk62_clementine400.prop");
    --CutscenePlayer("cutscene_s4", 0, 1, 0);
